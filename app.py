...
MONGODB_CONNECTION_STRING = 'mongodb+srv://arysanjaya:testing1234@cluster0.7irhzom.mongodb.net/?retryWrites=true&w=majority'
...
def get_posts():
    ...
    try:
        ...
        for post in posts:
            ...
            post["star_by_me"] = bool(db.likes.find_one({"post_id": post["_id"], "type": "star", "username": payload.get('id')}))
            post["thumbsup_by_me"] = bool(db.likes.find_one({"post_id": post["_id"], "type": "thumbsup", "username": payload.get('id')}))
        return jsonify(
            {
                "result": "success",
